...
/*Show all the descriptions of the pruducts in UPPER Case*/
...
(101, 'Michael',	'West',			'746 Oakwood St. Terre Haute, IN 47802',		'28.03.1978', 'married', '618-907-0603', 'westm28@email.com', 'card'),
(102, 'Jane',		'West',			'746 Oakwood St. Terre Haute, IN 47802',		'10.04.1980', 'married', '618-907-0602', 'westjane28@email.com', 'card'),
(103, 'Anna',		'Browne',		'73 Riverview St.Duarte, CA 91010',				'01.12.1980', 'divorced', '314-525-3971', 'brownea1@email.com', 'card'),
(104, 'Niko',		'Moses',		'380 Vine Drive Mundelein, IL 60060',			'13.08.1975', 'divorced', '847-598-4900', 'mosesn13@email.com', 'card'),
(105, 'Rubie',		'Holding',		'149 Sunnyslope Street Circle Pines, MN 55014', '17.10.1999', 'married', '419-201-7613', 'holdingr17@email.com', 'cash'),
(106, 'Jayson',		'Lyon',			'64 Wood Court Glendale, AZ 85302',				'14.09.1985', 'not married', '641-680-9411', 'lyonj14@email.com', 'cash'),
(107, 'Temirbolat', 'Maratuly',		'Karagandy, Yerzanova 39A',						'31.01.2001', 'not married', '232-231-4353', 't_maratuly@kbtu.kz', 'card'),
(108, 'Yevgeniy',	'Dubinin',		'Almaty, Tole Bi 59',							'27.12.2000', 'divorced', '134-213-5342', 'e_dubinin@kbtu.kz', 'cash'),
(109, 'Nuriman',	'Altybayeva',	'Almaty, Turgut Ozala 27',						'23.08.1999', 'married', '122-412-1553', 'n_altybaeva@kbtu.kz', 'card'),
(110, 'Naruto',		'Uzumaki',		'Almaty, Turgut Ozala 27',						'06.08.2001', 'married', '543-123-2145', 'n_uzumaky@gmail.com', 'cash');
...
create table hotel_staff(
	...
	constraint fk_hotel_staff_dep_id foreign key(hotel_staff_department_id) references department(department_id));

insert into hotel_staff values
(1,	'Edwin', 	'Schwartz',	111,	'Receptionist',	2000,	'eschawartz@gmail.com',	'505-466-8844',	'8429 Monroe Ave.Reston, VA 20191 Mcminnville, TN 37110',	'04.06.2018',	1),
(2,	'Donnie', 	'Tate',	222,	'Ñleaner',	1000,	'dontate@gmail.com',	'541-938-8185',	'8422 Squaw Creek Street Mcminnville, TN 37110',	'24.11.2019',	2),
(3,	'Braden',	'Winter',	333,	'Guard',	1500,	'bwinder@gmail.com',	'510-417-7421',	'65 Edgewater Drive Elizabeth City, NC 27909',	'11.01.2018',	1),
(4,	'Kofi', 	'Partridge',	555,	'HR Manager',	2500,	'kpartridge@gmail.com',	'509-474-4490',	'7639 North Riverview St.Urbandale, IA 50322',	'08.12.2019',	-2),
(5,	'Anna',	'Smyth',	666,	'DBA',	3000,	'asmyth@gmail.com',	'501-859-2090',	'9842 Berkshire St.	Jenison, MI 49428',	'09.02.2020',	-2),
(6,	'Olga',	'Tate',	222,	'Ñleaner',	1000,	'otate@gmail.com',	'123-234-1242',	'8422 Squaw Creek Street Mcminnville, TN 37110',	'10.11.2020',	3),
(7,	'Deril',	'Tate',	222,	'Ñleaner',	1000,	'dtate@gmail.com',	'124-512-4331',	'8422 Squaw Creek Street Mcminnville, TN 37110',	'24.01.2020',	4),
(8,	'Eduard',	'Tate',	222,	'Ñleaner',	1000,	'etate@gmail.com',	'123-432-1253',	'8422 Squaw Creek Street Mcminnville, TN 37110',	'31.01.2020',	5);
...
create table firm(
	...
	firm_department_id int ,
	firm_floor int  not null,
	firm_seat_number int not null,
	firm_start_date time not null,
	firm_end_time time not null,
	constraint fk_firm_department_id foreign key(firm_department_id) references department(department_id));
...
create table firm_staff(
	...
	constraint fk_firm_staff_firm_id foreign key(firm_id) references firm(firm_id));
...
insert into food_n values('f10', 'drink', 'Green Apple alcoholic cocktail'),
...
create table restaurant_menu(
	...
	food_id varchar(7) ,
	cost int not null,
	constraint fk_restaurant_menu_restaurant_id foreign key(restaurant_id) references firm(firm_id),
	constraint fk_restaurant_menu_food_id foreign key(food_id) references food_n(food_id));
...
create table Food_Detail_Invoice (
	...
	constraint fk_food_detail_invoice_food_id foreign key (food_id) references Food_n(food_id),
...
join Food_n f on f_d_i.food_id = f.food_id
